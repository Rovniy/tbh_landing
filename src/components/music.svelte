		...
		.cover_area
			...
			.visual
				...
				span
					...
					width: 10%
					height: #{$height / 2}
					background: linear-gradient(to top, rgba($uicolor_white, 1), rgba($uicolor_white, .5))
					transform-style: preserve-3d
					animation: music 1.5s infinite ease-in-out
					+tablet
						background: linear-gradient(to top, rgba($uicolor_black, .7), rgba($uicolor_black, .3))
