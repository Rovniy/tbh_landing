	...
	<div class="wrapper">
		...
		<ul>
			...
			<li>Affiliate means an entity that controls, is controlled by or is under common control with a party, where
				“control” means of 50% or more of the shares, equity interest or other securities entitled to vote for
				election of directors or other managing authority.
			</li>
			<li>Account means a unique account created for You to access our Service or parts of our Service.</li>
			<li>Service refers to the Website.</li>
			<li>Country refers to: Montenegro</li>
		...
		<p>Cookies can be “Persistent” or “Session” Cookies. Persistent Cookies remain on your personal computer or
			...
			Learn more about cookies here: Cookies: What Do They Do?</p>

		<h3>We use both session and persistent Cookies for the purposes set out below:</h3>

		<ul>
			<li>Necessary / Essential CookiesType: Session CookiesAdministered by: UsPurpose: These Cookies are
				...
				Cookies, the services
				that You have asked for cannot be provided, and We only use these Cookies to provide You with those
				services.
			</li>
			<li>Cookies Policy / Notice Acceptance CookiesType: Persistent CookiesAdministered by: UsPurpose: These
				Cookies identify if users have accepted the use of cookies on the Website.
			</li>
			<li>Functionality CookiesType: Persistent CookiesAdministered by: UsPurpose: These Cookies allow us to
				remember choices You make when You use the Website, such as remembering your login details or language
				preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid
				You having to re-enter your preferences every time You use the Website.
			</li>
			<li>Targeting and Advertising CookiesType: Persistent CookiesAdministered by: Third-PartiesPurpose: These
				Cookies track your browsing habits to enable Us to show advertising which is more likely to be of
				...
				You are on third party websites. For more information about the cookies we use and your choices
		...
		<ul>
			...
			<li>With other users: when You share personal information or otherwise interact in the public areas with
				...
				Third-Party Social
				Media Service may see You name, profile, pictures and description of Your activity. Similarly, other
		...
		<p>Your information, including Personal Data, is processed at the Company’s operating offices and in any
			otherplaces where the parties involved in the processing are located. It means that this information may be
		...
		<p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred.
			Wewill provide notice before Your Personal Data is transferred and becomes subject to a different
			PrivacyPolicy.</p>
		...
		<p>Appodeal Ads is provided by Appodeal Inc. You can opt-out from Appodeal Ads service by following the
			instructions as described by Appodeal Inc on their Privacy Policy page: <a
				href="https://appodeal.com/privacy-policy" target="_blank">https://appodeal.com/privacy-policy</a></p>
		...
		<p>By email: <a href="mailto:contact@ravy.pro" target="_blank">contact@ravy.pro</a></p>
	</div>
</main>
